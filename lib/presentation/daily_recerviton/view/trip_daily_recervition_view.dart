...
class TripDailyReservationView extends StatefulWidget {
  ...
  @override
  _TripDailyReservationViewState createState() => _TripDailyReservationViewState();
}
...
class _TripDailyReservationViewState extends State<TripDailyReservationView> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text("Daily reservation",
        style: Theme
            .of(context)
            .textTheme
            .labelLarge,
      ...
      body:
      Provider.of<DailyReservationViewModel>(context).getStateScreen() == 0
        ? contentWidget()
        : Provider.of<DailyReservationViewModel>(context).getStateScreen() == 1
        ? StateRenderer(
