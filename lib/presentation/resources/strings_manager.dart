...
class StringsManager{
  ...
  static const onBoardingTitle2 ="SEE THE BEST COURSE s2";
  static const onBoardingTitle3 ="SEE THE BEST COURSE s3";
  static const onBoardingTitle4 ="SEE THE BEST COURSE s4";

  static const onBoardingSubTitle1 ="Tut app is an awesone flutter application using clean architector s1";
  static const onBoardingSubTitle2 ="Tut app is an awesone flutter application using clean architector s1";
...
//  static String profile=LocaleKeys.profile.tr();
 ...
 // static String changePassword=LocaleKeys.changePassword.tr();
  ...
  //tatic String eAreas=LocaleKeys.eAreas.tr();
 ...
 // static  String busSite=LocaleKeys.busSite.tr();
  ...
  //static String send = LocaleKeys.send.tr();
  //static String program = LocaleKeys.Program.tr();
  //static String sat = LocaleKeys.Sat.tr();
  //static String sun = LocaleKeys.Sun.tr();
  //static String mon = LocaleKeys.Mon.tr();
  //static String tus = LocaleKeys.Tus.tr();
  //static String wed = LocaleKeys.Wed.tr();
  //static String thu = LocaleKeys.Thu.tr();
  //static String go_time = LocaleKeys.Gotime.tr();
  //static String return_time = LocaleKeys.Returntime.tr();
  //static String postion = LocaleKeys.Position.tr();
  //static String go_confirm = LocaleKeys.GoingConfirm.tr();
  //static String return_confirm = LocaleKeys.Returningconfirm.tr();
  //static String rating = LocaleKeys.Rating.tr();
  //static String searchlost=LocaleKeys.Searchlost.tr();
  //static String description=LocaleKeys.description.tr();
  //static String status=LocaleKeys.status.tr();
  //static String show_more=LocaleKeys.showmore.tr();
  //static String show_less=LocaleKeys.showless.tr();
  static String no_image=LocaleKeys.noimage.tr() ;
  //static String enter_image=LocaleKeys.enterimage.tr();
  //static String enter_complaint=LocaleKeys.Enteryourcompliaint.tr();
  //static String select_trip=LocaleKeys.selecttrip.tr();
  //static String enter_description_lostitem=LocaleKeys.descriptionlostitem.tr();
  //static String add_lost_item=LocaleKeys.addlostitem.tr();
  //static String search_stud=LocaleKeys.searchstudent.tr();
  //static String trip_information=LocaleKeys.tripinformation.tr();
  //static String seat=LocaleKeys.seat.tr();
  //static String accept=LocaleKeys.accept.tr();
 // static String reject=LocaleKeys.reject.tr();
  //static String daily_recieve=LocaleKeys.dailyrecieve.tr();
  //static String no_trip=LocaleKeys.notrip.tr();
